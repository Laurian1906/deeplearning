...
# se specifica locatia imaginilor pentru test
input_dir = 'dataset/test/test_dataset'

# in acest director se vor salva imaginile redimensionate
output_dir = 'dataset/resized_test'

# in acest director se vor salva imaginile pe care s-a aplica functia hog()
hog_dir = 'dataset/test_hog_train'

# daca nu exista fisierele se vor crea
